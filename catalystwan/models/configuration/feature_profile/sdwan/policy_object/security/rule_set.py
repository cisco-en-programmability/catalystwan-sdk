...
class Sequences(BaseModel):
    ...
    destination_data_ipv6_prefix_list: Optional[RefIdList] = Field(
        default=None,
        validation_alias="destinationDataIpv6PrefixList",
        serialization_alias="destinationDataIpv6PrefixList",
    )
    destination_data_prefix_list: Optional[RefIdList] = Field(
    ...
    destination_fqdn_list: Optional[RefIdList] = Field(
    ...
    destination_geo_location_list: Optional[RefIdList] = Field(
    ...
    destination_port_list: Optional[RefIdList] = Field(
    ...
    source_port_list: Optional[RefIdList] = Field(
