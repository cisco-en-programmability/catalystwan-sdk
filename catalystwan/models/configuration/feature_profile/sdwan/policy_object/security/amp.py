...
class AdvancedMalwareProtectionParcel(_ParcelBase):
    ...
    def create(
        ...
        _file_analysis_alert = Global[FileAnalysisAlert](value=file_analysis_alert) if file_analysis_alert else None
        ...
        return cls(
            ...
            file_reputation_cloud_server=Global[FileReputationServer](value=file_reputation_cloud_server),
            file_reputation_est_server=Global[FileReputationServer](value=file_reputation_est_server),
            file_analysis_alert=_file_analysis_alert,
            file_analysis_cloud_server=_file_analysis_cloud_server,
            file_reputation_alert=Global[FileReputationAlert](value=file_reputation_alert),
