...
class Color(BaseModel):
    color: Union[Global[TLOCColor], Variable]
    ...
    multiplier: Optional[Union[Global[int], Default[int], Variable]] = as_default(7)
    pmtu_discovery: Optional[Union[Global[bool], Default[bool], Variable]] = Field(
        default=as_default(True), validation_alias="pmtuDiscovery", serialization_alias="pmtuDiscovery"
    )
    dscp: Optional[Union[Global[int], Default[int], Variable]] = as_default(48)
...
class BFDParcel(_ParcelBase):
    ...
    multiplier: Optional[Union[Global[int], Default[int], Variable]] = Field(
        default=as_default(6), validation_alias=AliasPath("data", "multiplier")
    )
    poll_interval: Optional[Union[Global[int], Default[int], Variable]] = Field(
        default=as_default(600000),
        validation_alias=AliasPath("data", "pollInterval"),
        description="Poll Interval (In Millisecond)",
    )
    default_dscp: Optional[Union[Global[int], Default[int], Variable]] = Field(
